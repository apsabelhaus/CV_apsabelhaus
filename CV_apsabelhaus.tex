...
\hline
					& Conference:\Tstrut 	& Journal: 		& Total: 		& \multirow{3}{*}{\huge 914*  (376$^\dag$) \Tstrut}	& \multirow{3}{*}{\huge 15*  (8$^\dag$) \Tstrut} \\
...
\item J.C. Pacheco Garcia, M.L. Anderson, R. Jing, M. Ianus-Valdivia, \myname, ``Pose Estimation of Thermally-Actuated Soft Robots Using Discretized Rigid Approximations.''
...
\item {{\fontdescript{Mentorship of PhD students.}} 3 students. Diversity: 2/3 identify as minority or under-represented, 66\%.}

\item {{\fontdescript{Mentorship of master's students.}} 17 students. Diversity: 9/17 identify as minority or under-represented, 53\%.}

\item {{\fontdescript{Mentorship of undergraduate students.}} 18 students. Diversity: 12/18 identify as minority or under-represented, 66\%.}

\item {{\fontdescript{Instructor / Assistant Professor.}} Boston University.
 
\location{- Spring 2023 | Eng. 103, Computational Linear Algebra | In Progress}
...
\item {\fontdescript{Service to the Systems Engineering Division at Boston University:}}
	...
	\begin{tightitemize}
		\item Graduate Admissions Committee, 2022-2023
	\end{tightitemize}
