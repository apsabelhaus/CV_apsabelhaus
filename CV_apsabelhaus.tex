...
\renewcommand{\arraystretch}{1.2}
\begin{tabularx}{1\textwidth}{ p{3cm} | p{2cm} | p{2cm} | p{2cm} | p{4cm} | X }
\multicolumn{4}{ p{9cm} | }{ {\fontdescript{Peer-Reviewed Publication Count:}} } & {\fontdescript{Total Citations:}} & {\fontdescript{h-index:}} \\
\hline
					& Conference:\Tstrut 	& Journal: 		& Total: 		& \multirow{3}{*}{\huge 1022*  (458$^\dag$) \Tstrut}	& \multirow{3}{*}{\huge 15*  (10$^\dag$) \Tstrut} \\
1st-Author or PI: \Tstrut	& \Large 8 			& \Large 4 		& \Large 12	&										&  \\
All: 					& \Large 13		& \Large 10 		& \Large 23	&										& \\
\end{tabularx}
...
\item J.C. Pacheco Garcia, R. Jing, M.L. Anderson, M. Ianus-Valdivia, \myname, ``A Comparison of Mechanics Simplifications in Pose Estinmation for Thermally-Actuated Soft Robot Limbs.'' {\it ASME 2023 Conference on Smart Materials, Adaptive Structures, and Intelligent Systems (SMASIS)}, Sept. 2023

\item \underline{{\fontdescript{A.P. Sabelhaus}}}, Z. Patterson, A. Wertz, C. Majidi, ``Safe Supervisory Control of Soft Robot Actuators.'' {\it Under Review}. Available, arXiv:2208.01547

\item R. Jing, M. Anderson, M. Ianus-Valdivia, A. Akber, C. Majidi, \myname, ``Safe Balancing Control of a Soft Legged Robot.'' {\it Under Review}. Available arXiv:2209.13715
...
\item Peer review for Journals: x19 from 2017-2023. Peer review for conferences: x16 from 2016-2022.
\end{enumerate}
...
\vspace{-0.1cm}
\begin{enumerate}\setlength{\itemsep=0cm}
\item Instructor, Boston University. Computational Linear Algebra, 2022-2023, course evaluations overall instructor rating: 4.54/5.0. Introduction to Computer Programming, 2023: in progress.
\item Graduate Student Instructor (GSI), University of California Berkeley, 2018: Design of Microprocessor-Based Mechanical Systems. Course evaluations: 4.7/5.0 undergraduate students, 4.88/5.0 graduate students.
...
\vspace{-0.1cm}
\begin{enumerate}\setlength{\itemsep=0cm}
\item NASA Downlink Day with Astronaut Bob Hines at Boston University, 2022: hosted groups of under-represented K-12 students for lab tours and demos. Repeated in 2023.
