...
\item \ranname, \mername, M. Ianus-Valdivia, A. Akber Ali, C. Majidi, \myname, ``Safe Balancing Control of a Soft Legged Robot.'' {\it Late Breaking Results, IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS)}, 2023

\item \mername, \ranname, \juanname, I. Yang, S. Alizadeh-Shabdiz, \myname, ``Networks of Shape Memory Alloy Artificial Muscles Increase Force Output in Soft Robot Limbs.'' {\it Late Breaking Results, IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS)}, 2023
...
\item \ranname, \mername, M. Ianus-Valdivia, \myname, ``Safe Balancing Control of a Soft Legged Robot.'' {\it Northeast Regional Robotics Colloquium}, 2022
...
\item \myname, ``Close Enough is Good Enough: Approximations in Soft Robot Control.'' {\it Embodied Intelligence Conference}, 2022

\item \myname, ``Double-Helix Linear Actuators.'' {\it 4th ASME Journal of Mechanical Design Webinar}, American Society of Mechanical Engineers, Dec. 2021

\item \myname, ``Soft Robot Locomotion: Not as Hard as You Might Think.'' {\it Intelligence Community Academic Research Syposium}, United States Office of the Director of National Intelligence, Sept. 2021.

\item \myname, ``Controlling Soft Robots: Not as Hard as You Might Think.'' {\it NGA IC Postdoc Speaker Series}, National Geospatial Intelligence Agency (Online), June 2021.

\item \myname, ``Towards Rich Locomotion Gaits for Soft Robots.'' {\it CMU Locomotion Seminar}, Carnegie Mellon University, Nov. 2020.

\item \myname, C. Majidi, ``Gaussian Process Models for Soft Robot Locomotion." {\it Workshop on Application-Oriented Modeling and Control of Soft Robots, IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS)}, Oct. 2020.

\item \myname, ``Tensegrity Spines for Quadruped Robots.'' {\it Workshop on Tensegrity Robotics, IEEE International Conference on Robotics and Automation (ICRA),} May 2019.

\item \myname, ``Tensegrity Spines for Quadruped Robots.'' {\it CMU Locomotion Seminar}, Carnegie Mellon University, Feb. 2019.

\item \myname, ``Laika and Belka: Walking Robots with Flexible Spines.'' {\it Workshop on Autonomy for Future NASA Science Missions}, National Aeronautics and Space Administration, Oct. 2018.

\item \myname, A.K. Agogino, ``Inverse Kinematics for Tensegrity Soft Robot Control: Existence and Optimality.'' {\it Soft Robotics Modeling and Control Workshop, IEEE/RSJ International Conference on Intelligent Robots and Systems}, Oct. 2018.

\item \myname, ``Laika, The Four-Legged Robot with a Flexible Spine.'' {\it NASA Space Technology Day-On-The-Hill}, United States Congress / House of Representatives, Nov. 2017.

\item \myname, ``Laika, The Quadruped Robot with a Flexible Spine.'' {\it Bay Area Robotics Symposium (BARS)}, Oct. 2017.

\item \myname, ``Trajectory Tracking Control of a Flexible Spine Robot.'' {\it Workshop on Structurally Adaptive Tensegrity Robotics, 13th NASA/ESA Conference on Adaptive Hardware and Systems}, July 2017.

\item \myname, ``UC Berkeley Robotics for Disaster Relief.'' {\it Field Innovation Team Bootcamp 5.0}, Mar. 2017.

\item \myname, ``DNA-Structured Linear Actuators.'' {\it  SKTA Innopartners IP Redux}, Apr. 2016.

\item \myname, ``The ULTRA Spine Project.'' {\it Bay Area Robotics Symposium (BARS)}, Oct. 2015.

\item \myname, ``Robotics, Mechatronics, and Intelligent Systems.'' {\it Osher Lifelong Learning Institute}, Feb. 2014.
