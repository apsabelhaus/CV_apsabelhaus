...
\href{mailto:asabelha@bu.edu}{asabelha@bu.edu} | {\it he, him, his}}
}
...
\hline
						& 1st-Author:\Tstrut 	& Any Author: 	& \multirow{3}{*}{\huge 688*  (282$^\dag$) \Tstrut}	& \multirow{3}{*}{\huge 11*  (5$^\dag$) \Tstrut} \\
...
\item M. Zadan, D.K. Patel, \myname, J. Liao, A. Wertz, L. Yao, C. Majidi, ``Thermoelectrically Heated and Cooled Soft Liquid Crystal Elastomer Limbs for Dual use Actuation and Energy Harvesting,'' {\it Under Review, Nature Electronics.}
...
\item Z.J. Patterson, \underline{{\fontdescript{A.P. Sabelhaus}}}, C. Majidi, ``Robust Control of a Multi-Axis Shape Memory Alloy-Driven Soft Manipulator,'' {\it Under Review, IEEE Robotics and Automatics Letters}. arXiv:2110.10022

\item R.K. Mehta, \myname, C. Majidi, ``Learned Dynamics of Electrothermally-Actuated Soft Robot Limbs Using LSTM Neural Networks,'' {\it Under Review, IEEE International Conference on Soft Robotics}.
