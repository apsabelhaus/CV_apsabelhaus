...
\multicolumn{3}{ p{9cm} | }{ {\fontdescript{\large Peer-Reviewed Publication Count:}} } & {\fontdescript{\large Total Citations:}} & {\fontdescript{\large h-index:}} \\
\hline
						& \large 1st-Author:\Tstrut 	& \large Any Author: 	& \multirow{3}{*}{\huge 527*  (191$^\dag$) \Tstrut}	& \multirow{3}{*}{\huge 9*  (4$^\dag$) \Tstrut} \\
\large Conference: \Tstrut	& \Large 5 					& \Large 10 			& 													&  \\
\large Journal: 			& \Large 2					& \Large 3 			& 													& \\
\large Total: 				& \Large 7 					& \Large 13			&													&
\end{tabularx}
...
\item \underline{{\fontdescript{A.P. Sabelhaus}}}, K. Chin, Z. Patterson, C. Majidi, ``Fast Online Trajectory Optimization for Soft Robot Locomotion via Learned Dynamics Models."
...
\item \underline{{\fontdescript{A.P. Sabelhaus}}}, C. Majidi, ``Gaussian Process Models for Soft Robot Locomotion." {\it Workshop on Application-Oriented Modeling and Control of Soft Robots, IEEE/RSJ International Conference on Intelligent Robots and Systems}, Oct. 2020.
