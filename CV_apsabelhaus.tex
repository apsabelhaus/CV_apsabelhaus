...
\hline
					& Conference:\Tstrut 	& Journal: 		& Total: 		& \multirow{3}{*}{\huge 1530*  (777$^\dag$) \Tstrut}	& \multirow{3}{*}{\huge 17*  (12$^\dag$) \Tstrut} \\
1st-Author or PI: \Tstrut	& \Large 10 			& \Large 7 		& \Large 17	&										&  \\
All: 					& \Large 15		& \Large 14 		& \Large 29	&										& \\
\end{tabularx}
...
\item T. Ondogan, R. Jing, \myname, R. Tron, ``Koopman Control Factorization: Data-Driven Convex Controller Design for a Class of Nonlinear Systems,'' {\it Under Review}, \arxiv{2510.05359}
...
\vspace{0.1cm}
\begin{tightitemize}
\item {\it IEEE Robotics and Automation Letters (RA-L)}, 2025
\item {\it IEEE International Conference on Soft Robotics}, 2025
\item {\it IEEE International Conference on Soft Robotics}, 2024
...
\location{- Spring 2025 | Eng. 103, Computational Linear Algebra | Overall rating: 4.5/5}

\location{- Spring 2024 | Eng. 103, Computational Linear Algebra | Overall rating: 4.0/5}
...
\item {\fontdescript{Service to the Mechanical Engineering Department at Boston University:}}
	...
	\begin{tightitemize}
		\item Masters' Curriculum Committee, 2024-2025
...
\item {\fontdescript{Service to the Systems Engineering Division at Boston University:}}
	...
	\begin{tightitemize}
		\item Graduate Admissions Committee, 2022-2025
	\end{tightitemize}
