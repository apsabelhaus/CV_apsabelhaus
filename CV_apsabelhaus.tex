...
\hline
					& Conference:\Tstrut 	& Journal: 		& Total: 		& \multirow{3}{*}{\huge 1611*  (836$^\dag$) \Tstrut}	& \multirow{3}{*}{\huge 18*  (12$^\dag$) \Tstrut} \\
...
\item A. Dickson, J.C. Pacheco Garcia, M.L. Anderson, R. Jing, S. Alizadeh-Shabdiz, A.X. Wang, C. DeLorey, Z. Patterson, \myname, ``Safe Autonomous Environmental Contact for Soft Robots using Control Barrier Functions,'' {\it IEEE Robotics and Automation Letters (RA-L)}, Vol. 10, Issue 11, Nov. 2025. \doi{10.1109/LRA.2025.3609669}
...
\item T. Ondogan, R. Jing, \myname, R. Tron, ``Koopman Control Factorization: Data-Driven Convex Controller Design for a Class of Nonlinear Systems,'' {\it American Control Conference}, May 2026. \arxiv{2510.05359}
...
\item M.L. Anderson, R. Jing, J.C. Pacheco Garcia, I. Yang, S. Alizadeh-Shabdiz, C. DeLorey, \myname, ``Maximizing Consistent High-Force Output for Shape Memory Alloy Artificial Muscles in Soft Robots,'' {\it IEEE International Conference on Soft Robotics (RoboSoft)}, April 2024. \doi{10.1109/RoboSoft60065.2024.10521983}
...
\item R. Jing, M.L. Anderson, J.C. Pacheco Garcia, \myname, ``Self-Sensing for Proprioception and Contact Detection in Soft Robots Using Shape Memory Alloy Artificial Muscles,'' {\it Preprint Only.} \arxiv{2409.17111}
...
\item \beibeiname, \ranname, \akuaname, \myname, ``Trajectory Generation for Underactuated Soft Robot Manipulators Using Discrete Elastic Rod Dynamics.''
...
\item \myname, ``Safe Autonomy for Soft Robots,'' {\it Georgia Tech, OMSCS Human-Robot Interaction Seminar}, 2026.

\item \myname, ``Safe Autonomy for Soft Robots,'' {\it Worcester Polytechnic Institute, Dept. of Mechanical Engineering Seminar}, 2025.

\item \myname, ``Safe Autonomy for Soft Robots,'' {\it NSF Foundational Research in Robotics PI Meeting, Science of Autonomy Workshop}, 2025.

\item \myname, ``Safe Autonomy for Soft Robots in Space Environments,'' {\it IEEE International Conference on Soft Robotics: Workshop on Humanitarian Assistance and Relief from Disasters and Exploration in Robotics}, 2025.

\item \myname, ``Controlling Soft Robots: Safety, Autonomy, and Human Interaction.'' {\it Draper Labs}, 2024.

\item \myname, ``Challenges in Control and Autonomy for Soft Robots: Safety, Robustness, and Scalability.'' {\it University of Utah, Robotics Seminar}, 2023.
...
\vspace{0.1cm}
\begin{tightitemize}
\item {\it IEEE Robotics and Automation Letters (RA-L)}, 2025-ongoing
\item {\it IEEE International Conference on Soft Robotics}, 2024, 2025, 2026
\item {\it IEEE/RSJ Intelligent Robots and Systems Conference}, 2025
\item {\it IEEE International Conference on Robotics and Automation (ICRA))}, 2023
...
\item {{\fontdescript{Mentorship of PhD students.}} 5 students. Diversity: 4/5 identify as minority or under-represented, 80\%.}

\item {{\fontdescript{Mentorship of master's student researchers.}} 20 students. Diversity: 11/20 identify as minority or under-represented, 55\%.}

\item {{\fontdescript{Mentorship of undergraduate student researchers.}} 28 students. Diversity: 18/28 identify as minority or under-represented, 64\%.}

\item {{\fontdescript{Instructor / Assistant Professor.}} Boston University.

\location{- Fall 2025 | Mech. Eng. 500, Dynamics Modeling of Complex Mechanical Systems | Overall rating: 4.86/5}

\location{- Spring 2025 | Eng. 103, Computational Linear Algebra | Overall rating: 4.41/5}

\location{- Fall 2024 | Mech. Eng. 500, Dynamics Modeling of Complex Mechanical Systems | Overall rating: 4.42/5}

\location{- Spring 2024 | Eng. 103, Computational Linear Algebra | Overall rating: 4.17/5}
...
\item {{\fontdescript{Teaching Excellence in the Core Curriculum Award.}} Boston University, 2025}
...
\item {\fontdescript{Service to the Mechanical Engineering Department at Boston University:}}
	...
	\begin{tightitemize}
		\item Masters' Curriculum Committee, 2024-2026
		\item Faculty Hiring Commitee, 2024-2025
...
\item {\fontdescript{Service to the Systems Engineering Division at Boston University:}}
	...
	\begin{tightitemize}
		\item Graduate Admissions Committee, 2022-2026
	\end{tightitemize}
