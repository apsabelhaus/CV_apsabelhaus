...
\href{mailto:apsabelhaus@cmu.edu}{apsabelhaus@cmu.edu} | (301) 807-9842}
}
...
% On the next line:
\fontlocation{Disseration title: {\it Quadruped Robots with Tensegrity Spines}}
\hfill  %, have the date flush-right under the school name
\fontlocation{August 2019}

% Then, the committee members
{\fontlocation Disseration Committee: {\it Alice M. Agogino (Chair), Andrew Packard, Claire Tomlin, Murat Arcak}}
...
\item {\fontdescript{Model-Predictive Control with Inverse Statics Optimization for Tensegrity Spine Robots.}} \underline{Sabelhaus, A.P.}; Zhao, H.; Zhu, E.; Agogino, A.K.; Agogino, A.M.; {\it Under Review (Journal.)} Preprint available, arXiv:1806.08868
...
% Removing this section since I don't think it adds a whole lot now.
