...
\hline
						& 1st-Author or PI:\Tstrut 	& All: 	& \multirow{3}{*}{\huge 742*  (310$^\dag$) \Tstrut}	& \multirow{3}{*}{\huge 12*  (6$^\dag$) \Tstrut} \\
Conference: \Tstrut	& \Large 7 					& \Large 12 			& 													&  \\
Journal: 			& \Large 4					& \Large 8 			& 													& \\
Total: 				& \Large 11 					& \Large 20			&													&
\end{tabularx}
...
\item \myname, R.K. Mehta, A. Wertz, C. Majidi, ``In-Situ Sensing and Dynamics Predictions for Electrothermally-Actuated Soft Robot Limbs,'' {\it Frontiers in Robotics and AI}, Accepted for Publication.
...
\item X. Huang, Z. Patterson, \myname, W. Huang, K. Chin, Z. Ren, M.K. Jawed, C. Majidi, ``Unethered Soft Robots - Design and Closed Loop Motion Planning with Discrete Elastic Rods.'' {\it Under Review, Nature Communications.}
