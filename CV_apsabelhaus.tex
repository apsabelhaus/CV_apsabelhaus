...
{\location{\hspace{0.3cm} Dept. of Mechanical Engineering \hfill 2022 - Present}}
%{\location{\hspace{0.3cm} PI, Soft Robotics Control Lab \hfill Boston, MA}}

\vspace{0.1cm}

{\fontdescript{Carnegie Mellon University \hfill Postdoctoral Research Fellow}}

{\location{\hspace{0.3cm} Dept. of Mechanical Engineering \hfill 2019 - 2021}}
...
\hline
						& 1st-Author:\Tstrut 	& Any Author: 	& \multirow{3}{*}{\huge 695*  (283$^\dag$) \Tstrut}	& \multirow{3}{*}{\huge 11*  (5$^\dag$) \Tstrut} \\
Conference: \Tstrut	& \Large 7 					& \Large 12 			& 													&  \\
Journal: 			& \Large 3					& \Large 6 			& 													& \\
Total: 				& \Large 9 					& \Large 18			&													&
\end{tabularx}
...
\item A. Wertz*, \underline{{\fontdescript{A.P. Sabelhaus}}}*, C. Majidi, ``Trajectory Optimization for Thermally-Actuated Soft Planar Robot Limbs,'' {\it IEEE International Conference on Soft Robotics (RoboSoft)}, April 2022. *Equal Contribution.

\item \underline{{\fontdescript{A.P. Sabelhaus}}}, C.Majidi, ``Gaussian Process Dynamics Models for Soft Robots with Shape Memory Actuators.'' {\it IEEE International Conference on Soft Robotics (RoboSoft)}, April 2021.
...
\item M. Zadan, D.K. Patel, \myname, J. Liao, A. Wertz, L. Yao, C. Majidi, ``Thermoelectrically Heated and Cooled Soft Liquid Crystal Elastomer Limbs for Dual use Actuation and Energy Harvesting,'' {\it Under Review, Advanced Materials.}

\item R.K. Mehta, \myname, C. Majidi, ``Learned Dynamics of Electrothermally-Actuated Soft Robot Limbs Using LSTM Neural Networks,'' {\it Preprint Only}. Available, arXiv:2111.04851
...
\item \underline{{\fontdescript{A.P. Sabelhaus}}}, Z. Patterson, A. Wertz, C. Majidi, ``Safe Supervisory Control of Soft Robot Actuators.''

\item X. Huang, Z. Patterson, \underline{{\fontdescript{A.P. Sabelhaus}}}, W. Huang, K. Chin, Z. Ren, M.K. Jawed, C. Majidi, ``Simulating Dynamic Locomotion of Untethered Soft Robots for Design and Motion Planning.''
...
\vspace{0.1cm}
\begin{tightitemize}
\item Journals: {\it Soft Robotics, IEEE Robotics and Automation Letters (RA-L), IEEE Transactions on Control System Technology (T-CST), Journal of Open-Source Software (JOSS), IEEE Robotics and Automation Magazine, International Journal of Space Structures (IJSS)}. 
\vspace{0.1cm}
\item Conferences: {\it  IEEE International Conference on Robotics and Automation (ICRA),  IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS),  American Control Conference (ACC), ASME International Design Engineering Technical Conference (IDETC), IEEE Conference on Control Technology and Applications (CCTA)}. 
\end{tightitemize}}
...
\item {{\fontdescript{Mentorship of PhD students.}} Boston University: 2 students. Diversity: 1/2 identify as minority or under-represented, 50\%.}

\item {{\fontdescript{Mentorship of master's students.}} UC Berkeley Master of Engineering (M.Eng): 15 students. Diversity: 8/15 identify as minority or under-represented, 53\%.}

\item {{\fontdescript{Mentorship of undergraduate students.}} UC Berkeley and Carnegie Mellon University, 19 students. Diversity: 13/19 identify as minority or under-represented, 68\%.}
