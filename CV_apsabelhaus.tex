...
\descript{B.S. Mechanical Engineering, Minor in Comp. Sci.}
\location{May 2012}
...
% Single-column page now, no need to try the fancy double-column, since
% I'm eliminating a lot of the excess material here.
